...
int main(int argc,char **argv)
{
	...
	bund = new CPUBundling(fboSize);	
							//Create bundling engine; we'll use it for several graph bundling tasks in this class
...
{                                                                   //At the end of this, a bundled graph must be available in gdrawing_bund
    ...
    *gdrawing_bund = *gdrawing_orig;								//Copy the original drawing to gdrawing_bund, since we want to bundle it,
	...
	cout << "Number of iterations: " << bund->niter <<  endl;
	cout << "Kernel size: " << bund->h <<  endl;
	cout << "Smoothing factor: " << bund->lambda <<  endl;
	cout << "Smoothing iterations: " << bund->liter <<  endl;
 	cout << "Number of endpoints iterations: " << bund->niter_ms <<  endl;
	cout << "Endpoints kernel size: " << bund->h_ms <<  endl;
	cout << "Endpoints smoothing factor: " << bund->lambda_ends <<  endl;
	cout << "Edge sampling resolution: " << bund->spl <<  endl;
	cout << "Advection speed: " << bund->eps <<  endl;
	cout << "Directional bundling repulsion: " << bund->rep_strength <<  endl;
	cout << "Relaxation: " << relaxation <<  endl;
	cout << "Max displacement: " << max_displacement <<  endl;
	cout << "Displacement relative to edge length: " << displ_rel_edgelength <<  endl;
	cout << "Polyline style: " << polyline_style <<  endl;
	cout << "Directional: " << tangent <<  endl;
	cout << "GPU bundling: " << gpu_bundling <<  endl;
	cout << "Auto update: " << auto_update <<  endl;
	cout << "Density estimation: " << density_estimation <<  endl;
	cout << "Bundle shape: " << bundle_shape <<  endl;
	cout << "Block endpoints: " << block_endpoints <<  endl;
    
	bund->setInput(gdrawing_bund);									//Bundle the graph drawing

	

	cout<< " UNBUNDLED FIRST EDGE" << gdrawing_orig->draw[1]
