from modules.abstractBundling import AbstractBundling
...
class StraightLine(AbstractBundling):
    ...
    def bundle(self):
        """
        Formats the straightline drawing to compare against bundled. 
        Additionally removes any splines from the edges.
        """
