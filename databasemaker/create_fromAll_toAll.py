...
def main():
    ...
    # **Define source and destination country lists**
    source_countries = ['Romania', 'Bulgaria']  # Example source countries
    destination_countries = ['Italy', 'France']  # Example destination countries

    # Mapping from Airport ID to node ID
    airport_id_to_node_id = {}
    node_id = 0  # Node ID counter

    # Sets to store IDs of source and destination airports
...
'''
        ...
        with open('airport_data.csv', 'r', encoding='utf-8') as csvfile:
            ...
            for row in reader:
                ...
                # Check if the airport is in source or destination countries
